/*
  # Replace Location with Restock Information

  1. Changes
    - Remove location column from inventory table
    - Add restock_date and restock_notes columns
    - Update existing data structure
    - Modify functions to handle new fields

  2. New Fields
    - restock_date: When the item was last restocked
    - restock_notes: Notes about the restock (supplier, order info, etc.)
*/
...
-- Update the get_inventory_with_last_transaction function to include new fields
...
-- Update adjust_inventory_quantity function to handle restock information
